...
List<Githubuser> githubuserFromJson(String str) =>
    List<Githubuser>.from(json.decode(str).map((x) => Githubuser.fromJson(x)));

String githubuserToJson(List<Githubuser> data) =>
